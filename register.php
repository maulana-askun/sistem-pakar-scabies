...
<body>
    <div class="container d-flex justify-content-center py-5 ">
        <div class="card-register bg-info ">
            <div class="card-header  text-black">
                <h3 class="text-center mt-3">Halaman Registrasi</h3>
            </div>
            <div class="card-body ">
                <form id="registrationForm" method="POST" action="function.php?act=register" class="needs-validation" novalidate>
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="password" class="form-control mb-3" id="password" name="password" minlength="8" placeholder="Password" required>
                            <div class="valid-feedback">
                                Bagus!
                            </div>
                            <div class="invalid-feedback">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="date" class="form-control mb-3" id="tgl_lahir" name="tgl_lahir" required>
                            <div class="invalid-feedback">
                                Masukkan Tahun Lahir
                            </div>
                        </div>
                    </div>
                    <button type="submit" name="submitButton" id="submitButton" class="registerbtn btn bg-primary btn-block text-light">Register</button>
                    <br>

...
function registerPakar()
{
    ...
    $alamat = htmlspecialchars($_POST['alamat']);
    $tgl_lahir = $_POST['tgl_lahir'];
    $query_pakar = "INSERT INTO user (role, nama, email, alamat, tgl_lahir, password) VALUES ('2','$nama', '$email', '$alamat', '$tgl_lahir','$password')";
...
function tambahSolusi()
{
    ...
    $querySolusi = "INSERT INTO solusi (id_penyakit, solusi, deskripsi) VALUES ( $id_penyakit, '$solusi', '$deskripsi')";
